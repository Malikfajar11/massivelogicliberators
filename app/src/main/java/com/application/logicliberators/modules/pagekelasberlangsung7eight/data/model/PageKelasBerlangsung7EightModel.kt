package com.application.logicliberators.modules.pagekelasberlangsung7eight.`data`.model

import com.application.logicliberators.R
import com.application.logicliberators.appcomponents.di.MyApp
import kotlin.String

data class PageKelasBerlangsung7EightModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtDescription: String? = MyApp.getInstance().resources.getString(R.string.msg_nama_guru_dic)
  ,
  /**
   * TODO Replace with dynamic value
   */
