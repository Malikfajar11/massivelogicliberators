...
class SpinnerFrame1887OneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerFrame1887OneModel>
) : ArrayAdapter<SpinnerFrame1887OneModel>(mContext, layoutResource, allItems) {
